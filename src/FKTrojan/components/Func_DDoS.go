...
//------------------------------------------------------------
// 开启DDos攻击
// 例如：进行HttpGet攻击则： DDoSAttc("0","http://example.com",100)
func startDDosAttack(attc string, vic string, threads int, interval int) (string, error) {
	if attc == "0" { 	//HTTPGet
		...
		return "", errors.New("Start DDos with unknown type.")
	}
	return "Start DDos sucessed", nil
}
//------------------------------------------------------------
